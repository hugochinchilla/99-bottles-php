...
class BottlesTest extends PHPUnit_Framework_TestCase
{
  public function test_the_first_verse()
  {
    ...
    $this->assertEquals($expected, (new Bottles())->verses(99));
  }
  ...
  public function test_another_verse()
  {
    ...
    $this->assertEquals($expected, (new Bottles())->verses(3));
  }
  ...
  public function test_verse_2()
  {
    ...
    $this->assertEquals($expected, (new Bottles())->verses(2));
  }
  ...
  public function test_verse_1()
  {
    ...
    $this->assertEquals($expected, (new Bottles())->verses(1));
  }
  ...
  public function test_verse_0()
  {
    ...
    $this->assertEquals($expected, (new Bottles())->verses(0));
  }
